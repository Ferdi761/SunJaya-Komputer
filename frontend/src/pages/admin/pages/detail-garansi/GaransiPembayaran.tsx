    ...
    <div className='flex flex-row gap-10'>
      ...
      <div className='flex flex-col w-1/2 bg-dark text-white p-8 rounded-xl'>
        <div className='flex flex-row justify-between'>
          <p className='mb-5'>ID Garansi : #17</p>
        ...
        <div className='flex flex-row gap-10'>
          <Link
            to='/chat'
            className='text-center font-bold text-black bg-white w-1/2 rounded-full text-2xl py-2'>
            Diskusi Pengiriman
          </Link>
...
export default GaransiPembayaran
